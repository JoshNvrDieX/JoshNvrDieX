...
<img src="https://skillicons.dev/icons?i=discordjs,nodejs,react,ts,py,java,js,c,cpp,go,html,css,github,docker,vscode,git,linux,aws,figma,blender&theme=dark" />
...
```txt
Focused on code, fueled by good music 🎧
```
